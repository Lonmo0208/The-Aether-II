...
public class AetherIIFluids {
    ...
    public static final BaseFlowingFluid.Properties ACID_PROPERTIES = new BaseFlowingFluid.Properties(AetherIIFluidTypes.ACID_TYPE, ACID, FLOWING_ACID).block(AetherIIBlocks.ACID);
}
